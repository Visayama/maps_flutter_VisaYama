...
import 'dart:convert';
import 'model_rs/model_provinsi.dart';
...
class _PageProvinsiState extends State<PageProvinsi> {
  ...
  Future<void> fetchModelKampus() async {
    final response = await http.get(Uri.parse('http://192.168.100.100/listrumahsakit/provinsi.php'));
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            element.namaProvinsi.toLowerCase().contains(value.toLowerCase()) ||
                                element.idProvinsi.toLowerCase().contains(value.toLowerCase()))
                                .toList();
                          });
                        },
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PageKabupaten(idProvinsi: datum.idProvinsi),
                          ),
                        );
                      },
                      child: Container(
